...
public record PokePhoneRequestProgressPayload(String playerUuid) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, PokePhoneRequestProgressPayload> CODEC = PacketCodec.tuple(
            PacketCodecs.STRING, PokePhoneRequestProgressPayload::playerUuid,
            PokePhoneRequestProgressPayload::new
    );

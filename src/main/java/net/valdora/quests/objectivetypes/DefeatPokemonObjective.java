...
public class DefeatPokemonObjective extends Objective {
    ...
    public DefeatPokemonObjective(String title, String description, String questId, JsonObject json) {
        ...
        if (json.has("species")) {
            ...
            if (speciesStr.equalsIgnoreCase("any")) {
                ...
                if (species == null) {
                    Valdora.LOGGER.error("DefeatPokemonObjective: Pokemon Species '" + speciesStr + "' not found for quest " + questId);
                }
            }
        }
        ...
        if (json.has("pkmn_type")) {
            ...
            if (typeStr.equalsIgnoreCase("any")) {
                ...
                if (type == null) {
                    Valdora.LOGGER.error("DefeatPokemonObjective: Pokemon Type '" + typeStr + "' not found for quest " + questId);
                }
            }
        }
    ...
    public boolean handleObjectiveUpdate(ActiveQuest activeQuest, ServerPlayerEntity player, Object data) {
        ...
        if (any) {
            ...
            matched = species.equals(defeatedPokemon.getSpecies());
        } else if (type != null) {
            ElementalType pPrim = defeatedPokemon.getPrimaryType();

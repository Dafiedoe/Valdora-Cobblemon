...
public class ProfileRemoveConfirmationScreen extends Screen {
    ...
    protected void init() {
        ...
        addDrawableChild(ButtonWidget.builder(Text.literal("Yes"), button -> {
            client.getNetworkHandler().sendPacket(ClientPlayNetworking.createC2SPacket(new net.valdora.savedata.PlayerSaveDataManager.DeleteProfilePayload(profileName)));

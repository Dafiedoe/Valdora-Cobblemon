...
public class ProfileScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawText(textRenderer, Text.literal(titleText), width / 2 - textRenderer.getWidth(titleText) / 2, 20, 0xFFFFFF, true);
        
        int sidebarWidth = 180;
        String sidebarTitle = "Profiles";
        context.drawText(textRenderer, Text.literal(sidebarTitle), sidebarWidth / 2 - textRenderer.getWidth(sidebarTitle) / 2, 15, 0xFFFFFF, true);

...
public class ModEntities {
    ...
    public static void register() {
        ...
        Registry.register(
                ...
                Identifier.of(Valdora.MOD_ID, "surf_board"),
                SURF_BOARD
        );

        DUMMY_ENTITY = FabricEntityTypeBuilder
                .<DummyEntity>create(SpawnGroup.MISC, DummyEntity::new)
        ...
        Registry.register(
                Registries.ENTITY_TYPE,
                Identifier.of(Valdora.MOD_ID, "dummy"),
                DUMMY_ENTITY
        );
